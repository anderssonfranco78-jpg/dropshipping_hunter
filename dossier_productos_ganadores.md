...
date: "2026-09-26"
generated_at: "2026-09-26T15:37:57.316315+00:00"
...
> **Fecha de Generación**: 2026-09-26 | **Entorno**: 100% Programático & Headless  
...
Este dossier presenta los productos de comercio electrónico que han superado de forma matemática y rigurosa el **Filtro de Acero de las 7 Reglas de Oro de Antigravity**. Cada producto seleccionado cuenta con demostración visual instantánea (0-3 segundos), resolución de dolor agudo real, total ausencia en supermercados físicos de conveniencia, márgenes netos superiores al 65%, precios de venta dentro del rango de impulso ($29 – $69 USD), nula fricción por tallas o fragilidad, y líneas logísticas fiables de 7 a 12 días.

Cada ficha técnica incluye su desglose financiero completo, proveedores mayoristas verificados, estrategia demográfica, franjas horarias recomendadas y la **partitura técnica de los 4 Ganchos de Conversión** lista para producción en **Remotion Modalidad 3** (diálogos duales `es-US-Neural2-C` / `es-US-Neural2-B`, pausa dramática de 1.0s, beat drop y Floating3DText).
...
| **Comisión Pasarela** (Stripe 2.9% + $0.30) | $1.31 USD | Deducción automática por transacción | ✅ Incluido |
| **Buffer de Reserva** (1.0%) | $0.35 USD | Fondo para imprevistos / chargebacks | ✅ Incluido |
| **Beneficio Neto Limpio por Unidad** | **$25.13 USD** | Ganancia neta líquida operativa | ✅ Auditado |
| **Margen Neto** (%) | **71.8%** | Mínimo requerido: $\ge 65.0\%$ | ✅ EXCELENTE |
...
- **Países Tier 1 Homologados**: US, UK, DE, AU
...
- **Slot 1 (Matutino)** (07:00 – 08:30 Hora local del target): Rutina de cepillado frente al espejo; frustración directa al observar manchas y cálculo.
- **Slot 2 (Nocturno Prime)** (20:30 – 22:30 Hora local del target): Higiene nocturna antes de dormir; soledad en el baño revisando el teléfono descalzo.

#### Mecanismo WOW de Demostración (0 a 3 Segundos)

> Segundo 0.0-1.5: Macro 4K del interior de la boca sobre un molar con una costra marrón de sarro. Segundo 1.5-3.0: La punta metálica toca suavemente el sarro con un pitido ultrasónico ([SFX: ULTRASONIC_CHIRP]) y la costra se desmorona en pedazos sólidos instantáneamente dejando el esmalte impoluto. Acto seguido, la punta toca la cáscara de un huevo crudo o un globo inflado sin romperlo para demostrar que es 100% inocuo en encías.
...
*Curiosidad Disruptiva: El Metal que No Rompe Huevos*

- **Voz Cliente (`es-US-Neural2-C`)**: *"¿Cómo es posible que esto rompa piedra pero no pueda reventar un globo?"*
- **Voz Creador (`es-US-Neural2-B`)**: *"Porque tiene un sensor acústico que solo se activa al tocar sarro duro."*
...
|:---:|:---|:---|:---|:---|:---|
| **0.0 - 1.2s** | Una punta metálica vibrante toca la cáscara de un huevo crudo sin marcarlo; luego toca una costra dental y la pulveriza. | Snap zoom macro (1.0x -> 1.5x) al huevo y al cálculo dental. | Voz Cliente (es-US-Neural2-C): '¿Cómo es posible que esto rompa piedra pero no pueda reventar un globo?' | [SFX: RECORD_SCRATCH_QUICK] | '¿ROMPE PIEDRA?' en amarillo neón |
| **1.2 - 2.0s** | Detalle de la punta tocando la yema del dedo: cero vibración y cero dolor. | Paneo lateral suave. | Voz Creador (es-US-Neural2-B): 'Porque tiene un sensor acústico que solo se activa al tocar sarro duro.' | [SFX: VINE_BOOM] | 'SENSOR INTELIGENTE' en cian 3D |
| **2.0 - 3.0s** | CONGELADO EN LA PUNTA DE TITANIO TOCANDO EL DIENTE. | Silencio acústico riguroso de 1.0s. | Silencio sepulcral. | [SFX: SILENCIO_TOTAL] | Cero texto en pantalla |
| **3.0 - 4.5s** | Macro 4K real: la placa amarillenta entre dos dientes se desprende en un solo bloque limpio. | Beat Drop. Flash blanco y Speed Ramp (2.0x -> 0.18x meseta técnica). | Entra bajo potente LiQWYD. | [SFX: BEAT_DROP + CRACK_CLEAN] | 'SARRO DESTRUIDO' en titanio blanco 3D |
| **4.5 - 7.0s** | Se enjuaga con agua y se ve el esmalte blanco original reluciente como perla. | Paneo a la sonrisa impecable. | Voz Creador (es-US-Neural2-B): '40,000 vibraciones ultrasónicas por segundo. Sin taladros y sin sangre.' | [SFX: SHINE_SPARKLE] | '40,000 VIBRACIONES' en verde esmeralda |
| **7.0 - 10.0s** | Caja médica con puntas intercambiables de acero 316 y espejo bucal. | Zoom out fluido. | Voz Creador (es-US-Neural2-B): 'Hazte tu propia limpieza profesional en casa por menos de lo que cuesta el parking del dentista.' | [SFX: CASH_REGISTER] | 'AHORRA $250' |

##### 🪝 Gancho 2: Agitación de Dolor Real (Emotional Visceral Trigger)
*Agitación de Dolor Real: La Vergüenza de Sonreír en Fotos*

- **Voz Cliente (`es-US-Neural2-C`)**: *"Si dejas de sonreír en las fotos porque te da vergüenza el sarro amarillo acumulado..."*
- **Voz Creador (`es-US-Neural2-B`)**: *"Y no tienes $300 de sobra para pagarle al dentista cada 6 meses..."*

| Tiempo (s) | Video & Composición Visual | Movimiento Remotion (Speed Ramp) | Pista de Audio / Voces Neural2 | SFX & Beat Drop | Tipografía 3D Flotante (Floating3DText) |
|:---:|:---|:---|:---|:---|:---|
| **0.0 - 1.2s** | Persona hablando en público que se tapa la boca con la mano avergonzada al sonreír por tener manchas. | Snap zoom a la mano cubriendo la boca. | Voz Cliente (es-US-Neural2-C): 'Si dejas de sonreír en las fotos porque te da vergüenza el sarro amarillo acumulado...' | [SFX: HEARTBEAT_DULL] | '¿VERGÜENZA AL SONREÍR?' en rojo opaco |
| **1.2 - 2.0s** | Presupuesto dental en papel marcando: 'Deep Cleaning: $350.00'. | Paneo rápido al documento médico. | Voz Creador (es-US-Neural2-B): 'Y no tienes $300 de sobra para pagarle al dentista cada 6 meses...' | [SFX: VINE_BOOM] | '$350 EN LA CLÍNICA' en rojo neón |
| **2.0 - 3.0s** | CONGELADO EN EL PAPEL DE LA FACTURA DENTAL IMPOSIBLE. | 1.0 segundo de silencio puro. | Silencio absoluto. | [SFX: SILENCIO_TOTAL] | Cero texto en pantalla |
| **3.0 - 4.5s** | El ProSmile se enciende con su luz LED focal iluminando la boca en el espejo. | Beat Drop. Destello blanco y entrada musical enérgica. | Explota la base rítmica. | [SFX: BEAT_DROP + CHIRP] | 'LIMPIEZA EN CASA' en oro 3D |
| **4.5 - 7.0s** | En 3 pasadas suaves frente al espejo del baño, el sarro detrás de los incisivos desaparece. | Macro toma dental. | Voz Creador (es-US-Neural2-B): 'Elimina años de cálculo, manchas de café y nicotina en 5 minutos en tu propio baño.' | [SFX: WATER_RINSE] | 'EN SOLO 5 MIN' en verde esmeralda |
| **7.0 - 10.0s** | Sonrisa abierta, blanca y confiada frente al espejo del baño. | Zoom out cinemático. | Voz Creador (es-US-Neural2-B): 'Recupera tu confianza hoy mismo. Envío gratis y garantía de devolución total.' | [SFX: DING_SUCCESS] | 'GARANTÍA 100%' |

##### 🪝 Gancho 3: Contrariano (Challenging Conventional Wisdom)
*Contrariano: Por qué tu Cepillo de $120 No Sirve para el Sarro*

- **Voz Cliente (`es-US-Neural2-C`)**: *"Por qué cepillarte 3 veces al día jamás quitará el sarro duro de tus dientes..."*
- **Voz Creador (`es-US-Neural2-B`)**: *"El sarro es piedra caliza sólida; el cepillo de cerdas solo le hace cosquillas."*

| Tiempo (s) | Video & Composición Visual | Movimiento Remotion (Speed Ramp) | Pista de Audio / Voces Neural2 | SFX & Beat Drop | Tipografía 3D Flotante (Floating3DText) |
|:---:|:---|:---|:---|:---|:---|
| **0.0 - 1.2s** | Cepillo eléctrico sónico de $120 frotando enérgicamente un molar con sarro sin lograr quitar nada. | Snap zoom a las cerdas doblándose inútilmente. | Voz Cliente (es-US-Neural2-C): 'Por qué cepillarte 3 veces al día jamás quitará el sarro duro de tus dientes...' | [SFX: BRUSH_SCRUB_FAST] | 'NO LO QUITA' en rojo sangre arriba |
| **1.2 - 2.0s** | Gráfico microscópico: Las cerdas de nylon resbalan sobre el fosfato de calcio mineralizado. | Rotación 3D del modelo dental anatómico. | Voz Creador (es-US-Neural2-B): 'El sarro es piedra caliza sólida; el cepillo de cerdas solo le hace cosquillas.' | [SFX: VINE_BOOM] | 'ES PIEDRA MINERAL' en naranja 3D |
| **2.0 - 3.0s** | CONGELADO EN EL MODELO ANATÓMICO DENTAL. | Pausa de 1.0s de silencio sepulcral. | Silencio acústico riguroso. | [SFX: SILENCIO_TOTAL] | Cero texto en pantalla |
| **3.0 - 4.5s** | El cabezal de titanio del ProSmile toca la piedra; micro-cavitación acústica y la piedra se disuelve. | Beat Drop. Flash blanco y Speed Ramp (1.8x -> 0.18x meseta). | Explota el bajo de Show Me (LiQWYD). | [SFX: BEAT_DROP + ULTRASONIC_CHIRP] | 'CAVITACIÓN ACÚSTICA' en turquesa 3D |
| **4.5 - 7.0s** | Demostración de seguridad: la punta roza la encía y se detiene automáticamente en 1 milisegundo. | Macro a la encía rosada intacta sin sangrar. | Voz Creador (es-US-Neural2-B): 'Cero daño al esmalte y cero dolor en encías gracias a su sensor de densidad.' | [SFX: CHIME_SAFE] | 'CERO DAÑO' en verde esmeralda |
| **7.0 - 10.0s** | Vista del producto cargándose por USB-C junto al lavamanos moderno. | Zoom out fluido. | Voz Creador (es-US-Neural2-B): 'La herramienta que tu dentista no quiere que descubras. Pide el tuyo con 50% de descuento.' | [SFX: CASH_REGISTER] | '50% DE DESCUENTO' en amarillo 3D |

##### 🪝 Gancho 4: Transformación Inmediata (Before vs After)
*Transformación Inmediata: De 5 Años de Sarro a Dientes de Seda*

- **Voz Cliente (`es-US-Neural2-C`)**: *"De tener 5 años de sarro y manchas de tabaco pegadas a los dientes..."*
- **Voz Creador (`es-US-Neural2-B`)**: *"A dejarlos con textura de seda y completamente limpios en 10 minutos."*

| Tiempo (s) | Video & Composición Visual | Movimiento Remotion (Speed Ramp) | Pista de Audio / Voces Neural2 | SFX & Beat Drop | Tipografía 3D Flotante (Floating3DText) |
|:---:|:---|:---|:---|:---|:---|
| **0.0 - 1.2s** | Pantalla dividida: Lado izquierdo (dientes inferiores manchados de tabaco y sarro oscuro). | Snap zoom hacia la izquierda desaturada. | Voz Cliente (es-US-Neural2-C): 'De tener 5 años de sarro y manchas de tabaco pegadas a los dientes...' | [SFX: SAD_SCRATCH] | 'ANTES (5 AÑOS)' en marrón/rojo |
| **1.2 - 2.0s** | Lado derecho: Dientes limpios y blancos con brillo nítido de película. | Snap zoom hacia la derecha con resplandor luminoso. | Voz Creador (es-US-Neural2-B): 'A dejarlos con textura de seda y completamente limpios en 10 minutos.' | [SFX: SHINE_CHIME] | 'DESPUÉS (10 MIN)' en blanco diamante 3D |
| **2.0 - 3.0s** | CONGELADO EN EL CORTE VERTICAL DEL SPLIT SCREEN. | 1.0 segundo de silencio absoluto. | Silencio puro. | [SFX: SILENCIO_TOTAL] | Cero texto en pantalla |
| **3.0 - 4.5s** | La transición barre: se muestra en tiempo real sin cortes cómo el sarro se cae al escupir agua. | Beat Drop. Flash blanco y Speed Ramp dinámico. | Beat y bajo enérgico LiQWYD. | [SFX: BEAT_DROP + SPLASH] | 'SIN CORTES' en oro flotante 3D |
| **4.5 - 7.0s** | La persona pasa su lengua por detrás de los dientes con expresión de asombro total. | Paneo suave al rostro sonriente. | Voz Creador (es-US-Neural2-B): 'Siente la sensación de limpieza clínica profunda cada vez que quieras sin salir de tu casa.' | [SFX: POP_SOUND] | 'TEXTURA DE SEDA' en cian neón |
| **7.0 - 10.0s** | Kit completo con espejo bucal, 2 cabezales y cable en su estuche sellado. | Snap zoom out. | Voz Creador (es-US-Neural2-B): 'Stock limitado para envío en 7 a 10 días. Toca el botón y reclama tu kit hoy.' | [SFX: BELL_CHIME] | 'STOCK LIMITADO' |
...
| **Comisión Pasarela** (Stripe 2.9% + $0.30) | $1.89 USD | Deducción automática por transacción | ✅ Incluido |
| **Buffer de Reserva** (1.0%) | $0.55 USD | Fondo para imprevistos / chargebacks | ✅ Incluido |
| **Beneficio Neto Limpio por Unidad** | **$37.75 USD** | Ganancia neta líquida operativa | ✅ Auditado |
| **Margen Neto** (%) | **68.7%** | Mínimo requerido: $\ge 65.0\%$ | ✅ EXCELENTE |
...
- **Países Tier 1 Homologados**: US, UK, CA, AU
...
**Franja Horaria Recomendada de Publicación Orgánica**:
- **Slot 1 (Matutino)** (06:30 – 08:00 Hora local del target): Rigidez lumbar y dolor agudo al despertar de la cama; scrolleo compulsivo matutino.
- **Slot 2 (Mediodía)** (12:30 – 14:00 Hora local del target): Pausa tras 4 horas continuas de oficina o manejo de camión; fatiga lumbar acumulada.
- **Slot 3 (Prime Nocturno)** (19:30 – 21:30 Hora local del target): Fin de jornada laboral; relax en sofá buscando alivio antes de dormir.

#### Mecanismo WOW de Demostración (0 a 3 Segundos)

> Segundo 0.0-1.5: Plano cerrado lateral en cintura. El usuario conecta la manguera y presiona la bomba dos veces. Segundo 1.5-3.0: El cinturón se expande violentamente hacia arriba con un sonido neumático nítido ([SFX: PNEUMATIC_HISS]), estirando visiblemente el torso mientras una animación 3D de rayos X muestra las vértebras L1-L5 separándose y el nervio ciático pasando de rojo a azul relajado.
...
##### 🪝 Gancho 1: Curiosidad Disruptiva (Pattern Interrupt)
*Curiosidad Disruptiva: El Secreto Médico Prohibido*

- **Voz Cliente (`es-US-Neural2-C`)**: *"¿Por qué los camioneros tienen prohibido manejar sin inflarse esto?"*
- **Voz Creador (`es-US-Neural2-B`)**: *"Porque en 30 segundos separa tus vértebras 7 milímetros."*

| Tiempo (s) | Video & Composición Visual | Movimiento Remotion (Speed Ramp) | Pista de Audio / Voces Neural2 | SFX & Beat Drop | Tipografía 3D Flotante (Floating3DText) |
|:---:|:---|:---|:---|:---|:---|
| **0.0 - 1.2s** | Primer plano de una persona colocándose una faja de tracción con manómetro neumático. | Snap Zoom violento (1.0x -> 1.35x) con desenfoque radial dinámico. | Voz Cliente (es-US-Neural2-C): '¿Por qué los camioneros tienen prohibido manejar sin inflarse esto?' | [SFX: WHOOSH_FAST] | '¿PROHIBIDO?' en rojo neón extruido arriba (rotateX: 12deg) |
| **1.2 - 2.0s** | Detalle en 4K de las 24 columnas de aire en la espalda listas para cargarse. | Paneo lateral acelerado (1.8x rush). | Voz Creador (es-US-Neural2-B): 'Porque en 30 segundos separa tus vértebras 7 milímetros.' | [SFX: VINE_BOOM] | '7 MILÍMETROS' en verde esmeralda 3D |
| **2.0 - 3.0s** | PANTALLA CONGELADA CON SILUETA EN TENSIÓN ANATÓMICA. | Cero movimiento (Pausa dramática de 1.0s de tensión acústica). | Silencio sepulcral absoluto (cero voz). | [SFX: SILENCIO_TOTAL] | Cero texto en pantalla |
| **3.0 - 4.5s** | El cinturón se infla a tope; el torso se estira visiblemente. Destello blanco. | Beat Drop. Flash blanco y Speed Ramp no lineal (2.0x -> 0.18x meseta técnica). | Entra bajo enérgico y track musical (LiQWYD - Show Me). | [SFX: BEAT_DROP + PNEUMATIC_HISS] | 'DESCOMPRESIÓN L4-L5' en dorado 3D sin cajas ni pills |
| **4.5 - 7.0s** | Animación 3D de columna: el disco herniado vuelve a su centro al expandirse las vértebras. | Snap zoom a la zona lumbar con tracking volumétrico. | Voz Creador (es-US-Neural2-B): 'Libera el nervio ciático atrapado sin pisar un quirófano.' | [SFX: BONE_POP_RELIEF] | 'CIÁTICA DESBLOQUEADA' en cian neón 3D |
| **7.0 - 10.0s** | El usuario camina erguido, sonríe y se toca la espalda sin dolor. | Zoom out continuo (0.95x) hacia la llamada a la acción. | Voz Creador (es-US-Neural2-B): 'Pruébalo 14 días. Si tu espalda no revive, te devolvemos cada centavo.' | [SFX: CASH_REGISTER] | 'GARANTÍA 14 DÍAS' en amarillo brillante |

##### 🪝 Gancho 2: Agitación de Dolor Real (Emotional Visceral Trigger)
*Agitación de Dolor Real: El Ardor Lumbar al Levantarte*

- **Voz Cliente (`es-US-Neural2-C`)**: *"Si levantarte de la cama o del auto te toma 5 minutos por ese ardor lumbar..."*
- **Voz Creador (`es-US-Neural2-B`)**: *"Tus vértebras están aplastando este nervio ahora mismo."*

| Tiempo (s) | Video & Composición Visual | Movimiento Remotion (Speed Ramp) | Pista de Audio / Voces Neural2 | SFX & Beat Drop | Tipografía 3D Flotante (Floating3DText) |
|:---:|:---|:---|:---|:---|:---|
| **0.0 - 1.2s** | Persona que intenta levantarse de la silla de oficina y se queda doblada de agonía. | Snap zoom agresivo al rostro de dolor (1.0x -> 1.4x). | Voz Cliente (es-US-Neural2-C): 'Si levantarte de la cama o del auto te toma 5 minutos por ese ardor lumbar...' | [SFX: HEARTBEAT_LOW] | '¿ARDOR LUMBAR?' en rojo fuego 3D |
| **1.2 - 2.0s** | Primer plano al pulgar apretando la zona baja de la columna inflamada. | Camera shake de impacto visceral. | Voz Creador (es-US-Neural2-B): 'Tus vértebras están aplastando este nervio ahora mismo.' | [SFX: ELECTRIC_SPARK] | 'NERVIO PELLIZCADO' en amarillo neón |
| **2.0 - 3.0s** | CONGELADO EN EL MOMENTO DE TENSIÓN AGUDA DEL NERVIO. | Silencio acústico riguroso de 1.0s. | Cero voz, pausa absoluta. | [SFX: SILENCIO_TOTAL] | Cero texto en pantalla |
| **3.0 - 4.5s** | El usuario se coloca el cinturón y bombea aire 3 veces con alivio instantáneo. | Beat Drop. Flash blanco y Speed Ramp (1.8x rush -> 0.18x meseta). | Entra beat y bajo enérgico LiQWYD. | [SFX: BEAT_DROP + AIR_PUMP] | 'ADIÓS PRESIÓN' en titanio 3D reflectivo |
| **4.5 - 7.0s** | Expresión facial cambiando de sufrimiento a un suspiro de alivio genuino. | Paneo vertical suave de abajo hacia arriba. | Voz Creador (es-US-Neural2-B): '24 cámaras de aire absorben el peso de tu tronco de inmediato.' | [SFX: EXHALE_RELIEF] | 'ALIVIO EN 60 SEG' en verde esmeralda |
| **7.0 - 10.0s** | El usuario agachándose con soltura para levantar un objeto del suelo sin miedo. | Tracking dinámico 3D. | Voz Creador (es-US-Neural2-B): 'Vuelve a moverte sin miedo al pinchazo. Enlace en bio con 40% OFF hoy.' | [SFX: CLICK_POP] | '40% OFF HOY' en oro 3D |

##### 🪝 Gancho 3: Contrariano (Challenging Conventional Wisdom)
*Contrariano: La Farsa de las Fajas de Farmacia*

- **Voz Cliente (`es-US-Neural2-C`)**: *"Por qué gastar $150 en fajas de farmacia empeora tu dolor de espalda..."*
- **Voz Creador (`es-US-Neural2-B`)**: *"Porque apretar tu abdomen no separa tus huesos."*

| Tiempo (s) | Video & Composición Visual | Movimiento Remotion (Speed Ramp) | Pista de Audio / Voces Neural2 | SFX & Beat Drop | Tipografía 3D Flotante (Floating3DText) |
|:---:|:---|:---|:---|:---|:---|
| **0.0 - 1.2s** | Una faja elástica de neopreno barata de farmacia siendo arrojada al cubo de basura. | Snap Zoom directo al cubo de basura. | Voz Cliente (es-US-Neural2-C): 'Por qué gastar $150 en fajas de farmacia empeora tu dolor de espalda...' | [SFX: TRASH_SLAM] | 'NO SIRVEN' en rojo sangre sobre el cubo |
| **1.2 - 2.0s** | Modelo anatómico mostrando cómo una faja elástica solo comprime la carne hacia adentro. | Giro 3D volumétrico (rotateY: -15deg). | Voz Creador (es-US-Neural2-B): 'Porque apretar tu abdomen no separa tus huesos.' | [SFX: VINE_BOOM] | 'SOLO APRIETAN' en naranja 3D |
| **2.0 - 3.0s** | PANTALLA EN NEGRO / SILENCIO DE CONTRADICCIÓN. | Pausa acústica estricta de 1.0s. | Silencio total. | [SFX: SILENCIO_TOTAL] | Cero texto en pantalla |
| **3.0 - 4.5s** | Entrada triunfal del SpineRelief Pro inflándose en cámara lenta vertical. | Beat Drop. Flash blanco y Speed Ramp dinámico. | Explota la base musical rítmica. | [SFX: BEAT_DROP + HISS] | 'TRACCIÓN CLÍNICA' en titanio reflectivo |
| **4.5 - 7.0s** | Split screen animado: Faja elástica (fuerza horizontal dañina) vs SpineRelief Pro (fuerza vertical de descompresión). | Split screen animado con barras de fuerza 3D. | Voz Creador (es-US-Neural2-B): 'Esto estira verticalmente tu columna, imitando una camilla médica de $3,000.' | [SFX: DING_WIN] | 'TRACCIÓN VERTICAL' en cian neón |
| **7.0 - 10.0s** | Demostración de uso discreto bajo la camisa en la oficina o manejando. | Paneo lateral suave a 60 fps. | Voz Creador (es-US-Neural2-B): 'Úsalo bajo tu ropa mientras trabajas. Talla universal con extensor gratis.' | [SFX: DISCORD_PING] | 'TALLA UNIVERSAL' en amarillo 3D |

##### 🪝 Gancho 4: Transformación Inmediata (Before vs After)
*Transformación Inmediata: De la Incapacidad a la Plenitud*

- **Voz Cliente (`es-US-Neural2-C`)**: *"De no poder atarte las zapatillas por el dolor de ciática..."*
- **Voz Creador (`es-US-Neural2-B`)**: *"A pasar 6 horas de pie sin un solo tirón lumbar."*

| Tiempo (s) | Video & Composición Visual | Movimiento Remotion (Speed Ramp) | Pista de Audio / Voces Neural2 | SFX & Beat Drop | Tipografía 3D Flotante (Floating3DText) |
|:---:|:---|:---|:---|:---|:---|
| **0.0 - 1.2s** | Pantalla dividida: Lado izquierdo (Persona encorvada que no puede inclinarse a atarse los zapatos). | Zoom in hacia la izquierda con tono desaturado y frío. | Voz Cliente (es-US-Neural2-C): 'De no poder atarte las zapatillas por el dolor de ciática...' | [SFX: RECORD_SCRATCH] | 'ANTES' en rojo desaturado |
| **1.2 - 2.0s** | Lado derecho: La misma persona trotando y jugando con sus hijos sin molestia alguna. | Snap zoom al lado derecho brillante y saturado. | Voz Creador (es-US-Neural2-B): 'A pasar 6 horas de pie sin un solo tirón lumbar.' | [SFX: WHOOSH_SWOOSH] | 'DESPUÉS' en verde esmeralda 3D |
| **2.0 - 3.0s** | CONGELADO EN EL CORTE CENTRAL DE CONTRASTE. | Silencio dramático riguroso de 1.0s. | Silencio absoluto. | [SFX: SILENCIO_TOTAL] | Cero texto en pantalla |
...
1. **Pistas de Voz Duales**: Utilizar Google Cloud TTS con la configuración canónica:
   - **Voz Cliente (Escéptico/Testigo)**: `es-US-Neural2-C` (Speaking rate: 1.04x, Pitch: 0.0st).
   - **Voz Creador (Experto/Autoridad)**: `es-US-Neural2-B` (Speaking rate: 1.08x, Pitch: +0.5st).
